...
@section('content')
    ...
    <hr>
    <form method="POST" action="{{ route('requisitionInputs.store') }}" enctype="multipart/form">
        @csrf
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <label for="exampleInputPassword1" class="form-label">Loan Classification</label>
