...
@section('content')
    ...
    <form method="POST" action="{{ route('farms.store') }}" enctype="multipart/form">
        @csrf
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="legal_owner_name" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <label for="exampleInputEmail1" class="form-label">Farm Size Ha</label>
                <input type="text" class="form-control" name="farm_size_ha" required>
            </div>
            <div class="col-md-6">
                <label for="exampleInputPassword1" class="form-label">Farm Size Acres</label>
                <input type="text" class="form-control" name="farm_size_acres" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <label for="exampleInputEmail1" class="form-label">Geolocation</label>
                <input type="text" class="form-control" name="geo_location_id" required>
            </div>
        </div>
        <br>
