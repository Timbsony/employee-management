...
@section('content')
    ...
    <hr>
   <div align="right"><a href="{{ route('requisitionCash.create') }}" class="btn btn-success my-2" >Create</a></div>
    <div class="py-5">
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="{{route("requisitionCash.edit",$item->id) }}">Edit</a>
                            <a class="dropdown-item" href="{{route("requisitionCash.destroy",$item->id) }}">Delete</a>
                        </div>
                    </div>
                </td>
            </tr>
